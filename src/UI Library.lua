...
local drawing = {} do
    ...
    function drawing:new(shape)
        ...
        objexists[obj] = true
        pcall(setrenderproperty, obj, "Visible", false)
        local signalnames = {}
            ...
            __newindex = function(self, k, v)
                    ...
                    if objchildren[parent] then
                        for _, object in next, objchildren[parent] do
                            if udim2sizeobjs[object] then
                                ...
                                newsize = Vector2.new(math.max(0, newsize.X), math.max(0, newsize.Y))
                                object.Size = newsize
                ...
                if k == "Size" then
                    ...
                    if typeof(v) == "Vector2" then
                        v = Vector2.new(math.max(0, math.floor(v.X)), math.max(0, math.floor(v.Y)))
                    end
                end
